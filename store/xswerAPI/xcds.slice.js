...
export const api_v1_xcds_list = createAsyncThunk("xcds/api_v1_xcds_list", async payload => {
  const response = await apiService.api_v1_xcds_list(payload);
  return response.data;
});
export const api_v1_xcds_create = createAsyncThunk("xcds/api_v1_xcds_create", async payload => {
  const response = await apiService.api_v1_xcds_create(payload);
  return response.data;
});
export const api_v1_xcds_retrieve = createAsyncThunk("xcds/api_v1_xcds_retrieve", async payload => {
  const response = await apiService.api_v1_xcds_retrieve(payload);
  return response.data;
});
export const api_v1_xcds_update = createAsyncThunk("xcds/api_v1_xcds_update", async payload => {
  const response = await apiService.api_v1_xcds_update(payload);
  return response.data;
});
export const api_v1_xcds_partial_update = createAsyncThunk("xcds/api_v1_xcds_partial_update", async payload => {
  const response = await apiService.api_v1_xcds_partial_update(payload);
  return response.data;
});
export const api_v1_xcds_destroy = createAsyncThunk("xcds/api_v1_xcds_destroy", async payload => {
